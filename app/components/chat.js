    ...
    render() {
        ...
        return (
            <div className="container clearfix">
                <UserList database={this.props.database} selectUser={this.selectUser} users={this.state.users} />
                <ChatBox currentUserStatus={this.state.currentUserStatus} idLookup={this.usernameFromID} geotab={this.props.geotab} userName={this.props.userName} socket={this.props.socket} database={this.props.database} currentUser={this.state.currentUser} />
            </div>
        )
    }
}