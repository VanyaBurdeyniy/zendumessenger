    ...
    _createClass(ChatBox, [{
        ...
        value: function componentWillMount() {
            ...
            this.props.socket.on('messages', function (data) {
                data = data.filter(function (message) {
                    return message.to == _this2.props.userID;
                });
                _this2.setState({
