        ...
        value: function componentWillMount() {
            ...
            this.props.socket.on('msg', function (data) {
                ...
                data = data.filter(function (message) {
                    return message.userName == _this2.props.userName;
                });
